...
struct story_1_panel_12: View {
    ...
    private let layers = [
        Layer(id: 0, imageName: "newPanel15", depthEffect: 1.0),
    ]
                            ...
                            ZStack() {
                                ForEach(layers, id: \.id) { layer in
                                    Image(layer.imageName)
                                        ...
                                        .onAppear {
                                            self.position = CGPoint(x: geometry.size.width / 2 - 40, y: geometry.size.height / 2 + 150)
                                        }
                                }
                            }
                        }
...
struct story_1_panel_12_Previews: PreviewProvider {
